...
export default function MenuPage({ user, onSignOut }) {
  ...
  const menuItems = {
    'Burgers': [
      ...
      { id: 4, name: 'Burger with Bacon', price: 42, category: 'Burgers', image: burgerBacon, emoji: '🍔', tag: 'SIGNATURE', description: 'Crispy bacon makes this burger special', ingredients: ['Patty', 'Bacon', 'Bun'] },
      { id: 5, name: 'Cheese Burger', price: 35, category: 'Burgers', image: cheeseBurger, emoji: '🍔', tag: 'SIGNATURE', description: 'Melted cheese perfection', ingredients: ['Patty', 'Cheese', 'Bun'] },
